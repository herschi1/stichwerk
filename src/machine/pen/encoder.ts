/**
 * Taken from Respira (https://github.com/jhbruhn/respira), Apache License 2.0.
 * Modified for Stichwerk: import paths adjusted. See NOTICE.md.
 */
/**
 * PEN Format Encoder
 *
...
import { MOVE, TRIM, END } from "../../engine/constants";
